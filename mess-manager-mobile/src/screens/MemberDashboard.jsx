...
export default function MemberDashboard({ navigation }) {
    ...
    return (
        <View className="flex-1 bg-slate-50 items-center justify-center p-6">
            <Text className="text-2xl font-black text-slate-900 mb-2 text-center">Member Dashboard</Text>
            <Text className="text-slate-500 mb-8 font-bold text-center">Welcome back!</Text>
