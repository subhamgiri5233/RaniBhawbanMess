            ...
            <AnimatePresence mode="wait">
                {notification ? (
                    <motion.div
                        ...
                        className="p-6 bg-amber-500/10 border border-amber-500/20 backdrop-blur-xl rounded-[2rem] flex flex-col items-center text-center gap-6 relative overflow-hidden group min-h-[350px] justify-center"
                    >
                        ...
                        <div className="w-16 h-16 rounded-3xl bg-amber-500 flex items-center justify-center shadow-xl shadow-amber-500/30 rotate-3">
                            <AlertCircle className="text-white" size={32} />
                        </div>
                        <div className="space-y-2">
                            <h3 className="text-amber-500 text-lg font-black uppercase tracking-[0.2em]">Security Alert</h3>
                            <p className="text-slate-600 dark:text-slate-300 font-bold text-base tracking-tight leading-relaxed max-w-[280px]">{notification.message}</p>
                        </div>
                        <button
                            onClick={() => setNotification(null)}
                            className="px-8 py-3.5 bg-amber-500 hover:bg-amber-400 text-white font-black text-xs uppercase tracking-widest rounded-2xl transition-all active:scale-95 shadow-xl shadow-amber-500/30 ring-1 ring-white/20"
                        >
                            Login Again
                        </button>
                    </motion.div>
