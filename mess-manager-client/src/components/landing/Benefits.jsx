    ...
    return (
        <section id="benefits" className="max-w-[1600px] mx-auto px-4 sm:px-6 mb-28">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 rounded-3xl p-8 sm:p-12 bg-gradient-to-br from-indigo-950/60 via-slate-900/80 to-slate-900/90 border border-indigo-500/20 shadow-2xl backdrop-blur-2xl relative overflow-hidden flex flex-col justify-between">
                    ...
                    <div>
                        ...
                        <h2 className="text-3xl sm:text-5xl font-[950] text-white tracking-tight uppercase leading-[0.95] mb-6 max-w-2xl">
                            Zero margin for calculation error. <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-purple-400 to-emerald-400">
                                100% Institutional Trust.
                            </span>
                        </h2>

                        <p className="text-slate-400 text-sm sm:text-base font-medium max-w-xl leading-relaxed mb-8">
                            Manual paper registers and spreadsheet formulas lead to lost receipts and dispute friction. Rani Bhawban Terminal automates end-to-end accounting with verifiable mathematics.
                        </p>
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-6 border-t border-white/10">
                        {[
                            'Real-Time Balance Synchronized',
                            'Precise Bengali PDF Generation',
                            'Auto-Collision Duty Prevention',
                            'Historical Audit Freeze Snapshots'
                        ].map((text, idx) => (
                ...
                {/* Card 2: Security & Transparency Stat Card (1 col) */}
                <div className="rounded-3xl p-8 bg-slate-900/70 border border-white/10 shadow-xl backdrop-blur-2xl flex flex-col justify-between">
                    <div>
                        ...
                        <p className="text-xs text-slate-400 font-medium leading-relaxed mb-6">
                            Single-device login authentication, role-based admin permission controls, and audit trace logs for complete mess management integrity.
                        </p>
                    </div>

                    <div className="p-4 rounded-2xl bg-white/5 border border-white/5 space-y-2">
                        <div className="flex justify-between items-center text-xs">
                            <span className="text-slate-400 font-bold uppercase text-[10px]">Session Guard</span>
                            <span className="text-emerald-400 font-extrabold">Active</span>
                        </div>
                        <div className="flex justify-between items-center text-xs">
                            <span className="text-slate-400 font-bold uppercase text-[10px]">Data Integrity</span>
                            <span className="text-indigo-400 font-extrabold">Verifiable</span>
                        </div>
                    </div>
                </div>
            </div>
