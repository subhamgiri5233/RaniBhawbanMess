...
const Layout = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-100/80 via-[#eceaff] to-violet-100/60 dark:bg-none dark:bg-slate-950 transition-colors duration-300">
            ...
            <div className="md:hidden sticky top-0 z-[40] px-4 py-3 bg-white/70 dark:bg-slate-950/80 backdrop-blur-xl border-b border-slate-200/50 dark:border-white/10 flex items-center justify-between transition-all shadow-sm shadow-indigo-500/5">
                ...
                <div className="flex items-center gap-1.5">
                    <button
                        ...
                        className="p-2.5 text-slate-500 dark:text-slate-500 hover:bg-slate-100 dark:hover:bg-white/5 rounded-xl transition-all active:scale-90"
                    >
            ...
            <button
                ...
                className="hidden md:flex items-center gap-2 fixed top-4 right-6 z-50 px-3 py-1.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-xl shadow-md text-slate-500 dark:text-slate-500 hover:text-primary-600 dark:hover:text-primary-400 hover:border-primary-300 hover:shadow-lg transition-all duration-200 text-xs font-black uppercase tracking-widest disabled:opacity-60"
            >
